...
# Задаём вопрос модели без контекста из книги.
# Детали художественного произведения модель может не знать или перепутать.
...
# Загружаем текст романа Булгакова.
# encoding="utf-8" задаём явно, чтобы корректно читать кириллицу на любой ОС.
loader = TextLoader("./data/bulgakov_utf8.txt", encoding="utf-8")
