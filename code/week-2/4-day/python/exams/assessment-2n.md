...
Проинициализируйте проект и подготовьте необходимые файлы. Убедитесь, что:
...
После завершения разработки, выполните финальный `git add -A`, `git commit`. Дождитесь 14:50, затем выполните `git push`. Это задание оценивается на основе функциональности вашего приложения, поэтому сосредоточьтесь на его реализации.
